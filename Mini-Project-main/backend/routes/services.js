...
    // Build query: Only fetch active services
    const query = {
      status: 'active'
    };
...
    }
    sort.priority = -1; // Prioritized services come first
    sort.createdAt = -1; // Fallback to newest first
...
    // Assumes getFeatured is a static method on the Service model
...
    // Ensure the service is active before returning to the public
...
    // In a live application, the authenticated user (req.user) data should be merged here
    const userData = {
...
    // Assumes checkEligibility is a method on the Service Mongoose document
...
// @desc    Get service categories metadata
...
// @desc    Get service departments metadata
// @route   GET /api/services/meta/departments
// @access  Public
...
// @desc    Search services and get title suggestions
...
    // Find services matching the text query, limiting to active status
...
// @desc    Get service statistics overview
